...
# Addon Name: Serije i Koncerti
# Addon id: plugin.video.serije
# Addon Provider: Hello
...
URL                 = 'https://github.com/realmakod/realserikod/tree/master/plugin.video.serije/'
ADDONTITLE          = ’Serije i Koncerti’
